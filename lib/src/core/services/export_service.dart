...
class ExportContentBuilder {
  ...
  String _buildCsv(List<LogEntry> entries, Map<String, String> categoryNames) {
    final buffer = StringBuffer()
      ..writeln(
        'id,timestamp,task,category,problemFaced,solutionTried,result,notes,important,createdAt,updatedAt',
      );
    ...
    return encoder.convert([
      for (final entry in entries)
        <String, Object?>{
          ...
          'problemFaced': entry.problem,
          'solutionTried': entry.solutionTried,
