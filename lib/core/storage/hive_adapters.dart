  ...
  LogEntry read(BinaryReader reader) {
    ...
    return LogEntry(
      ...
      entryType: fields.containsKey(11)
          ...
          : LogEntryType.manual,
      flavor: fields.containsKey(12)
          ? LogEntryFlavor.values[fields[12] as int]
          : ((fields.containsKey(11) && (fields[11] as int) != 0)
                ? LogEntryFlavor.legacySession
                : LogEntryFlavor.legacyStructured),
      transcript: fields[13] as String?,
